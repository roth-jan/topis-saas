    ...
    gates: {
      ...
      items: {
        ...
        properties: {
          ...
          torBreiteM: { type: 'number', description: 'Breite/Länge eines Tors entlang der Wand in m (z.B. 4 bei "jedes Tor 4 m breit")' },
          lueckeM: { type: 'number', description: 'LÜCKE zwischen benachbarten Toren in m ("Abstand zum nächsten Tor", "Abstand zwischen den Toren", "X m dazwischen")' },
          spacingM: { type: 'number', description: 'NUR falls explizit Achsabstand Mitte-zu-Mitte genannt; sonst lueckeM nutzen' },
...
const SYSTEM = [
  ...
  'Tor-Breite ("jedes Tor 4 m breit") → gates[].torBreiteM. "Abstand zum/zwischen den Toren" ist die',
  'LÜCKE → gates[].lueckeM (NICHT spacingM). Der Achsabstand ergibt sich aus Breite + Lücke.',
