 ...
 * Basiert auf dem ROTH 976-Zeilen-Excel, reduziert auf die ~50 Kernschritte,
...
const PROZESSMODELL_SE = {
    ...
    beschreibung: 'Standard SE-Prozess: Entladen → Scannen → Verteilen → Beladen',
    prozessTyp: 'se',
...
function berechneMinProColli(modell, parameter) {
    ...
    const abteilungsErgebnisse = abteilungen.map((abt)=>{
        const schritte = aktualisierteScritte.filter((s)=>s.abteilung === abt);
        const gesamtSek = schritte.reduce((sum, s)=>sum + (s.berechneteZeitSek || 0), 0);
        const minProColli = gesamtSek / 60;
        return {
            abteilung: abt,
            label: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$prozessmodell$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ABTEILUNG_LABELS"][abt],
            minProColli,
            anteilGesamt: 0,
...
//# sourceMappingURL=src_lib_3271d29d._.js.map