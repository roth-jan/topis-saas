...
"[project]/src/types/prozessmodell.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AbteilungsChart({ abteilungen, width = 400, height = 200 }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        abteilungen.forEach((abt, i)=>{
            ...
            ctx.textAlign = 'right';
            ctx.fillText(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$prozessmodell$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ABTEILUNG_LABELS"][abt.abteilung], padding.left - 8, y + barH / 2 + 4);
            // Bar
            ctx.fillStyle = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$prozessmodell$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ABTEILUNG_COLORS"][abt.abteilung];
            ctx.globalAlpha = 0.8;
...
function BenchmarkRadar({ aktuell, benchmark, width = 300, height = 250 }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const maxVal = Math.max(...abteilungen.map((a)=>Math.max(aktuell[a] || 0, benchmark[a] || 0)), 0.01);
        ...
        abteilungen.forEach((abt, i)=>{
            ...
            ctx.fillText(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$prozessmodell$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ABTEILUNG_LABELS"][abt], lx, ly);
        });
        // Draw polygon helper
...
function DashboardPage() {
    ...
    const flaechenAnalyse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$flaechenrechner$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["berechneFlaechenbedarf"])(scandatenRecords, relationZuordnungen, objects);
    }, [
        scandatenRecords,
        relationZuordnungen,
        objects
...
//# sourceMappingURL=src_c26ae9a1._.js.map