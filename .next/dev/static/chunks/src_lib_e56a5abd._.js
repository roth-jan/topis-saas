...
function berechneMinProColli(modell, parameter) {
    ...
    const abteilungsErgebnisse = abteilungen.map((abt)=>{
        ...
        return {
            abteilung: abt,
            label: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$prozessmodell$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ABTEILUNG_LABELS"][abt],
            minProColli,
            anteilGesamt: 0,
...
//# sourceMappingURL=src_lib_e56a5abd._.js.map