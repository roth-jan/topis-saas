    ...
    const runAnalyse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CheckPage.useCallback[runAnalyse]": async (csvText, fileName)=>{
            ...
            try {
                ...
                setAnalyseSchritt(0);
                await tick();
                const { records, erkanntesProfil } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$spaltenzuordnungen$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseCsvMitProfil"])(csvText);
                if (records.length === 0) {
                ...
                const uniqueStellplaetze = new Set(records.map({
                    "CheckPage.useCallback[runAnalyse]": (r)=>r.stellplatz
                }["CheckPage.useCallback[runAnalyse]"]).filter(Boolean));
                const uniqueRelationen = new Set(records.map({
                    "CheckPage.useCallback[runAnalyse]": (r)=>r.ausgangsrelation
                }["CheckPage.useCallback[runAnalyse]"]).filter(Boolean));
                const daten = records.filter({
                    "CheckPage.useCallback[runAnalyse].daten": (r)=>r.scandatum
                }["CheckPage.useCallback[runAnalyse].daten"]).map({
                    "CheckPage.useCallback[runAnalyse].daten": (r)=>r.scandatum
                }["CheckPage.useCallback[runAnalyse].daten"]);
                ...
                const totalColli = records.reduce({
                    "CheckPage.useCallback[runAnalyse].totalColli": (sum, r)=>sum + r.colli
                }["CheckPage.useCallback[runAnalyse].totalColli"], 0);
                const uniqueDays = new Set(records.map({
                    "CheckPage.useCallback[runAnalyse]": (r)=>r.scandatum
                }["CheckPage.useCallback[runAnalyse]"]).filter(Boolean));
                ...
                const parameter = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$prozessmodell$2d$se$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SE_STANDARD_PARAMETER"].map({
                    "CheckPage.useCallback[runAnalyse].parameter": (p)=>{
                ...
                }["CheckPage.useCallback[runAnalyse].parameter"]);
                ...
                const benchmarkErgebnis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$benchmarking$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["berechneBenchmark"])(ergebnis, parameter.find({
                    "CheckPage.useCallback[runAnalyse].benchmarkErgebnis": (p)=>p.id === 'verteilweg'
                }["CheckPage.useCallback[runAnalyse].benchmarkErgebnis"]).aktuellerWert, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$referenzhallen$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["REFERENZHALLEN"], 'Ihre Halle');
                ...
                const stundenProfil = istSoll.stunden.map({
                    "CheckPage.useCallback[runAnalyse].stundenProfil": (s)=>({
                            stunde: s.stunde,
                            soll: s.sollMA,
                            ist: 0,
                            colli: s.colli
                        })
                }["CheckPage.useCallback[runAnalyse].stundenProfil"]);
                ...
                const analyse = {
                    ...
                    gesamtSendungen: records.reduce({
                        "CheckPage.useCallback[runAnalyse]": (sum, r)=>sum + r.sendungen
                    }["CheckPage.useCallback[runAnalyse]"], 0),
                    gesamtColli: totalColli,
                    gesamtGewicht: records.reduce({
                        "CheckPage.useCallback[runAnalyse]": (sum, r)=>sum + r.gewicht
                    }["CheckPage.useCallback[runAnalyse]"], 0),
                    objektMetriken: layout.torZuordnungen.map({
                        "CheckPage.useCallback[runAnalyse]": (tz)=>{
                            const torRecords = records.filter({
                                "CheckPage.useCallback[runAnalyse].torRecords": (r)=>r.stellplatz === tz.stellplatzKey
                            }["CheckPage.useCallback[runAnalyse].torRecords"]);
                            return {
                                objectId: tz.objectId,
                                objectName: tz.objectName,
                                sendungen: torRecords.reduce({
                                    "CheckPage.useCallback[runAnalyse]": (sum, r)=>sum + r.sendungen
                                }["CheckPage.useCallback[runAnalyse]"], 0) / arbeitstage,
                                colli: torRecords.reduce({
                                    "CheckPage.useCallback[runAnalyse]": (sum, r)=>sum + r.colli
                                }["CheckPage.useCallback[runAnalyse]"], 0) / arbeitstage,
...
_s(CheckPage, "6hD+HGnjYnOFaXY7QBl2cUO0kgs=", false, function() {
    return [
...
//# sourceMappingURL=src_0b1ff5d3._.js.map